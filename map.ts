...
async function producerReward() {
  ...
  //     let updateFindEntity = findTransactionsTypeForThisLoop.map(
  //       obj => {
  //           return {
  ...
  //     let updateFindWallet = findTransactionsTypeForThisLoop.map(
  //       obj => {
  //           return {
  //           "Wallet":obj.Account,
  //           }
  ...
  //     let updateFindCounter = findTransactionsTypeForThisLoop.map(
  //       obj => {
  //           return {
  ...
  //     let updateFindAsset = findTransactionsTypeForThisLoop.map(
  //       obj => {
  //           return {
  ...
  //     let updateFindDate = findTransactionsTypeForThisLoop.map(
  //       obj => {
  //           return {
  ...
  //     let updateFindDebit = findTransactionsTypeForThisLoop.map(
  //       obj => {
  //           return {
  ...
  //     let updateFindCredit = findTransactionsTypeForThisLoop.map(
  //       obj => {
  //           return {
  ...
  //     let updateFindid = findTransactionsTypeForThisLoop.map(
  //       obj => {
  //           return {
  //               "CryptoDBid": obj.id,
  //           }
  ...
  //     let updateFindDuration = findTransactionsTypeForThisLoop.map(
  //       obj => {
  //           return {
