...
-- AddForeignKey
ALTER TABLE "Fifo" ADD CONSTRAINT "Fifo_sPLId_fkey" FOREIGN KEY ("sPLId") REFERENCES "SPL"("id") ON DELETE SET DEFAULT ON UPDATE SET DEFAULT;

-- AddForeignKey
ALTER TABLE "AccountingJE" ADD CONSTRAINT "AccountingJE_CryptoDBid_fkey" FOREIGN KEY ("CryptoDBid") REFERENCES "SPL"("id") ON DELETE SET DEFAULT ON UPDATE SET DEFAULT;

-- AddForeignKey
ALTER TABLE "AccountingJE" ADD CONSTRAINT "AccountingJE_FifoDBid_fkey" FOREIGN KEY ("FifoDBid") REFERENCES "Fifo"("id") ON DELETE SET DEFAULT ON UPDATE SET DEFAULT;
